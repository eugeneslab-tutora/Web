...
[ "_memory", "___indirect_function_table", "_emWriteCookies", "_emReadCookies", "_jsHaveAsyncify", "_jsHaveJspi", "___asyncjs__qt_jspi_suspend_js", "_qt_jspi_resume_js", "_qt_jspi_can_resume_js", "_init_jspi_support_js", "_qt_asyncify_suspend_js", "_qt_asyncify_resume_js", "_main", "onRuntimeInitialized" ].forEach(prop => {
...
wasmBinaryFile = "appuntitled.wasm";
...
function emWriteCookies(line) {
 document.cookie = UTF8ToString(line);
}

function emReadCookies() {
 const coockies = document.cookie;
 var lengthBytes = lengthBytesUTF8(coockies) + 1;
 var stringOnWasmHeap = _malloc(lengthBytes);
 stringToUTF8(coockies, stringOnWasmHeap, lengthBytes);
...
var ___start_em_js = Module["___start_em_js"] = 9235032;

var ___stop_em_js = Module["___stop_em_js"] = 9236402;
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = appuntitled_entry;
else if (typeof define === 'function' && define['amd'])
  define([], () => appuntitled_entry);
